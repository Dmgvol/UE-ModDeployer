# Example Script for UE-ModDeployer
# This script provides a sample configuration.

# Refer to the README for full usage instructions and customisation options.
...
PROJECT_DIR = "C:\\UE Modding\\RooftopsandAlleys\\"
PROJECT_NAME = "RooftopsandAlleys"
LOG_DIR = os.path.join(PROJECT_DIR, "Saved", "Logs")
LOG_FILE_PATH = os.path.join(LOG_DIR, f"{PROJECT_NAME}.log")

# Config JSON
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
CONFIG_JSON_PATH = os.path.join(SCRIPT_DIR, "mods.json")

# PAK Files
WAIT_FOR_NEW_BUILD = True
CONTINUOUS_MODE = True
PAK_SOURCE_DIR = os.path.join(PROJECT_DIR, "Build", "Windows", PROJECT_NAME, "Content", "Paks")
PAK_TARGET_ROOT = f"C:\\Program Files (x86)\\Steam\\steamapps\\common\\{PROJECT_NAME}\\{PROJECT_NAME}\\Content\\Paks"
FILE_EXTENSIONS = ["pak", "ucas", "utoc"]
